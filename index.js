...
// Виведе: https://example.com/pathname?param1=value1&param2=value2// Завдання 4
...
function getUrlData(url) {
  ...
  urlData.origin = urlObject.origin;
  urlData.hostname = urlObject.hostname;
  urlData.port = urlObject.port;
  urlData.username = urlObject.username;
  urlData.password = urlObject.password;
